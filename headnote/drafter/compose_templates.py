...
MENTION_MEMO = {
    ...
    "fields": [
        {"key": "court_name",      "label_en": "Court",                       "label_hi": "न्यायालय",                "type": "text",  "required": True,  "hint": "e.g. 'Supreme Court of India' or 'MP High Court, Gwalior Bench'"},
        {"key": "case_no",         "label_en": "Case number",                 "label_hi": "केस क्रमांक",             "type": "text",  "required": True,  "hint": "e.g. 'Crl. Appeal 1234/2025' or 'WP(C) 567/2026'"},
        {"key": "case_title",      "label_en": "Case title (parties)",        "label_hi": "केस शीर्षक (पक्षकार)",    "type": "text",  "required": True,  "hint": "e.g. 'Vikesh Sharma vs State of MP'"},
        {"key": "bench",           "label_en": "Bench / Court no.",           "label_hi": "बेंच / कोर्ट क्रमांक",     "type": "text",  "required": False, "hint": "e.g. 'Hon'ble Chief Justice's Bench' or 'Court No. 5'"},
        {"key": "mention_reason",  "label_en": "Reason for urgent mention",   "label_hi": "अर्जेंट मेंशन का कारण",    "type": "longtext", "required": True, "hint": "Why the matter needs urgent attention"},
        {"key": "proposed_date",   "label_en": "Proposed listing date",       "label_hi": "प्रस्तावित सुनवाई दिनांक","type": "date",  "required": False},
        {"key": "advocate_name",   "label_en": "Advocate name",               "label_hi": "अधिवक्ता का नाम",         "type": "name",  "required": True},
        {"key": "advocate_enrollment", "label_en": "Bar Council enrolment no.","label_hi": "बार काउंसिल पंजीयन क्रमांक","type": "text", "required": False},
        {"key": "advocate_for",    "label_en": "Appearing for",               "label_hi": "किस ओर से",               "type": "text",  "required": True, "hint": "e.g. 'Petitioner' or 'Respondent No. 1'"},
        {"key": "place",           "label_en": "Place",                       "label_hi": "स्थान",                    "type": "text",  "required": True},
        {"key": "filing_date",     "label_en": "Date",                        "label_hi": "दिनांक",                    "type": "date",  "required": True},
    ],
    "format_spec": (
...
QUASHING_PETITION = {
    ...
    "fields": [
        {"key": "court_name",        "label_en": "High Court",                 "label_hi": "उच्च न्यायालय",              "type": "text",     "required": True, "hint": "e.g. 'MP High Court, Gwalior Bench'"},
        {"key": "petitioner_name",   "label_en": "Petitioner name",            "label_hi": "याचिकाकर्ता का नाम",         "type": "name",     "required": True},
        {"key": "petitioner_father", "label_en": "Father's name",              "label_hi": "पिता का नाम",                "type": "name",     "required": True},
        {"key": "petitioner_age",    "label_en": "Age",                        "label_hi": "आयु",                         "type": "text",     "required": False},
        {"key": "petitioner_occupation","label_en": "Occupation",              "label_hi": "व्यवसाय",                     "type": "text",     "required": False},
        {"key": "petitioner_address","label_en": "Address",                    "label_hi": "पता",                         "type": "address",  "required": True},
        {"key": "fir_number",        "label_en": "FIR No.",                    "label_hi": "FIR क्रमांक",                 "type": "text",     "required": True},
        {"key": "fir_date",          "label_en": "FIR date",                   "label_hi": "FIR दिनांक",                  "type": "date",     "required": True},
        {"key": "police_station",    "label_en": "Police Station",             "label_hi": "पुलिस थाना",                  "type": "text",     "required": True},
        {"key": "district",          "label_en": "District",                   "label_hi": "जिला",                        "type": "text",     "required": True},
        {"key": "sections_str",      "label_en": "Sections in FIR",            "label_hi": "FIR की धाराएं",               "type": "section_list", "required": True},
        {"key": "complainant_name",  "label_en": "Complainant (Respondent 2)", "label_hi": "शिकायतकर्ता (विपक्षी क्र.2)","type": "name",     "required": False, "hint": "FIR complainant — usually impleaded as Respondent No. 2"},
        {"key": "brief_facts_alleged","label_en": "Allegations in FIR",        "label_hi": "FIR के आरोप",                 "type": "longtext", "required": True, "hint": "Verbatim or summarised allegations"},
        {"key": "grounds_for_quashing","label_en": "Grounds for quashing",     "label_hi": "निरस्तीकरण के आधार",          "type": "longtext", "required": True, "hint": "Why the FIR should be quashed (no offence made out / civil dispute given criminal colour / mala fide / settlement)"},
        {"key": "stage_of_proceedings","label_en": "Current stage",            "label_hi": "वर्तमान चरण",                  "type": "text",     "required": False, "hint": "e.g. 'Investigation pending', 'Charge-sheet filed', 'Cognizance taken'"},
        *_ADVOCATE_FIELDS,
    ],
    "format_spec": (
...
WRIT_PETITION = {
    ...
    "fields": [
        {"key": "court_name",        "label_en": "High Court",                 "label_hi": "उच्च न्यायालय",              "type": "text",     "required": True},
        {"key": "writ_type",         "label_en": "Type of writ",               "label_hi": "रिट का प्रकार",              "type": "text",     "required": True, "hint": "mandamus / certiorari / habeas corpus / prohibition / quo warranto"},
        {"key": "writ_category",     "label_en": "Civil or Criminal writ",     "label_hi": "सिविल या आपराधिक रिट",     "type": "text",     "required": False, "hint": "WP(C) = Civil, WP(Crl) = Criminal"},
        {"key": "petitioner_name",   "label_en": "Petitioner name",            "label_hi": "याचिकाकर्ता",                "type": "name",     "required": True},
        {"key": "petitioner_father", "label_en": "Father's name",              "label_hi": "पिता का नाम",                "type": "name",     "required": True},
        {"key": "petitioner_age",    "label_en": "Age",                        "label_hi": "आयु",                         "type": "text",     "required": False},
        {"key": "petitioner_occupation","label_en": "Occupation",              "label_hi": "व्यवसाय",                     "type": "text",     "required": False},
        {"key": "petitioner_address","label_en": "Address",                    "label_hi": "पता",                         "type": "address",  "required": True},
        {"key": "respondent_authority","label_en": "Respondent authority",     "label_hi": "विपक्षी प्राधिकारी",         "type": "longtext", "required": True, "hint": "e.g. 'State of MP through Principal Secretary, Home Dept; Superintendent of Police, Gwalior'"},
        {"key": "impugned_action",   "label_en": "Impugned action / order",    "label_hi": "विवादित कार्य / आदेश",        "type": "longtext", "required": True, "hint": "What is being challenged"},
        {"key": "subject_summary",   "label_en": "Subject in one line",        "label_hi": "विषय (एक पंक्ति में)",       "type": "text",     "required": True, "hint": "e.g. 'For quashing the arbitrary transfer order dated 01.03.2026'"},
        {"key": "facts_narrative",   "label_en": "Facts of the case",          "label_hi": "मामले के तथ्य",              "type": "longtext", "required": True},
        {"key": "legal_violation",   "label_en": "Legal / fundamental rights violated", "label_hi": "उल्लंघित अधिकार",   "type": "longtext", "required": True, "hint": "Article 14, 19, 21 etc., or specific statutory rights"},
        {"key": "grounds_for_writ",  "label_en": "Grounds for the writ",       "label_hi": "रिट के आधार",                "type": "longtext", "required": True},
        {"key": "relief_sought",     "label_en": "Specific relief sought",     "label_hi": "अभीप्सित अनुतोष",            "type": "longtext", "required": True},
        {"key": "alternative_remedy_exhausted","label_en": "Alternative remedy exhausted?","label_hi": "वैकल्पिक उपचार समाप्त?","type": "text", "required": False, "hint": "Yes/No + brief explanation"},
        *_ADVOCATE_FIELDS,
    ],
    "format_spec": (
...
DEFAULT_BAIL = {
    ...
    "fields": [
        {"key": "court_name",        "label_en": "Court",                       "label_hi": "न्यायालय",                "type": "text",     "required": True,  "hint": "Court where charge-sheet was to be filed — Magistrate / Sessions"},
        {"key": "applicant_name",    "label_en": "Applicant name",              "label_hi": "आवेदक का नाम",            "type": "name",     "required": True},
        {"key": "applicant_father",  "label_en": "Father's name",               "label_hi": "पिता का नाम",             "type": "name",     "required": True},
        {"key": "applicant_address", "label_en": "Address",                     "label_hi": "पता",                     "type": "address",  "required": True},
        {"key": "fir_number",        "label_en": "FIR No.",                     "label_hi": "FIR क्रमांक",             "type": "text",     "required": True},
        {"key": "police_station",    "label_en": "Police Station",              "label_hi": "पुलिस थाना",              "type": "text",     "required": True},
        {"key": "sections_str",      "label_en": "Sections invoked",            "label_hi": "धाराएं",                  "type": "section_list", "required": True},
        {"key": "arrest_date",       "label_en": "Date of arrest",              "label_hi": "गिरफ्तारी की दिनांक",     "type": "date",     "required": True, "hint": "Critical for 60/90 day computation"},
        {"key": "remand_dates",      "label_en": "Remand dates",                "label_hi": "रिमांड की तिथियां",       "type": "longtext", "required": False, "hint": "Chronology of remand extensions"},
        {"key": "current_jail",      "label_en": "Current jail",                "label_hi": "वर्तमान कारागार",         "type": "text",     "required": True},
        {"key": "max_punishment",    "label_en": "Maximum punishment for offence","label_hi": "अधिकतम सज़ा",            "type": "text",     "required": True, "hint": "Determines whether 60 or 90 day period applies"},
        {"key": "charge_sheet_filed","label_en": "Has charge-sheet been filed?", "label_hi": "क्या चार्जशीट दाखिल हुई?","type": "text",     "required": True, "hint": "No / Yes (date)"},
        *_ADVOCATE_FIELDS,
    ],
    "format_spec": (
...
DISCHARGE_APPLICATION = {
    ...
    "fields": [
        {"key": "court_name",        "label_en": "Court",                        "label_hi": "न्यायालय",                "type": "text",     "required": True, "hint": "Sessions Court (§250) or Magistrate (§258)"},
        {"key": "applicant_name",    "label_en": "Applicant (accused) name",     "label_hi": "आवेदक का नाम",            "type": "name",     "required": True},
        {"key": "applicant_father",  "label_en": "Father's name",                "label_hi": "पिता का नाम",             "type": "name",     "required": True},
        {"key": "applicant_address", "label_en": "Address",                      "label_hi": "पता",                     "type": "address",  "required": True},
        {"key": "case_no",           "label_en": "Sessions/Criminal case no.",   "label_hi": "सत्र/अपराधिक केस क्रमांक","type": "text",     "required": True},
        {"key": "fir_number",        "label_en": "FIR no.",                      "label_hi": "FIR क्रमांक",             "type": "text",     "required": True},
        {"key": "police_station",    "label_en": "Police Station",               "label_hi": "पुलिस थाना",              "type": "text",     "required": True},
        {"key": "sections_str",      "label_en": "Sections",                     "label_hi": "धाराएं",                  "type": "section_list", "required": True},
        {"key": "charge_sheet_date", "label_en": "Charge-sheet date",            "label_hi": "चार्जशीट दिनांक",        "type": "date",     "required": False},
        {"key": "discharge_grounds", "label_en": "Grounds for discharge",        "label_hi": "उन्मोचन के आधार",         "type": "longtext", "required": True, "hint": "Why no prima facie case is made out"},
        {"key": "facts_narrative",   "label_en": "Brief facts of the case",      "label_hi": "मामले के तथ्य",          "type": "longtext", "required": True},
        *_ADVOCATE_FIELDS,
    ],
    "format_spec": (
...
MAINTENANCE = {
    ...
    "fields": [
        {"key": "court_name",        "label_en": "Court",                       "label_hi": "न्यायालय",                "type": "text",     "required": True, "hint": "Family Court or JM First Class with jurisdiction"},
        {"key": "petitioner_name",   "label_en": "Petitioner name",             "label_hi": "याचिकाकर्ता का नाम",      "type": "name",     "required": True, "hint": "Wife / child / parent claiming maintenance"},
        {"key": "petitioner_father", "label_en": "Petitioner father's name",    "label_hi": "पिता का नाम",             "type": "name",     "required": False},
        {"key": "petitioner_address","label_en": "Petitioner address",          "label_hi": "याचिकाकर्ता का पता",     "type": "address",  "required": True},
        {"key": "petitioner_age",    "label_en": "Petitioner age",              "label_hi": "आयु",                     "type": "text",     "required": False},
        {"key": "respondent_name",   "label_en": "Respondent (husband) name",   "label_hi": "विपक्षी (पति) का नाम",     "type": "name",     "required": True},
        {"key": "respondent_father", "label_en": "Respondent father's name",    "label_hi": "विपक्षी के पिता का नाम",  "type": "name",     "required": False},
        {"key": "respondent_address","label_en": "Respondent address",          "label_hi": "विपक्षी का पता",          "type": "address",  "required": True},
        {"key": "marriage_date",     "label_en": "Date of marriage",            "label_hi": "विवाह की दिनांक",         "type": "date",     "required": False},
        {"key": "marriage_place",    "label_en": "Place of marriage",           "label_hi": "विवाह स्थल",              "type": "text",     "required": False},
        {"key": "separation_date",   "label_en": "Date of separation",          "label_hi": "अलगाव की दिनांक",         "type": "date",     "required": False},
        {"key": "children_details",  "label_en": "Children (if any)",           "label_hi": "बच्चे (यदि कोई हों)",    "type": "longtext", "required": False, "hint": "Names, ages, who has custody"},
        {"key": "respondent_income", "label_en": "Respondent's monthly income", "label_hi": "विपक्षी की मासिक आय",     "type": "text",     "required": True},
        {"key": "petitioner_income", "label_en": "Petitioner's income (if any)","label_hi": "याचिकाकर्ता की आय",       "type": "text",     "required": False},
        {"key": "grounds_for_claim", "label_en": "Grounds for maintenance claim","label_hi": "भरण-पोषण के आधार",       "type": "longtext", "required": True, "hint": "cruelty / desertion / neglect / refusal to maintain"},
        {"key": "amount_sought",     "label_en": "Monthly maintenance sought (₹)","label_hi": "मासिक भरण-पोषण की मांग (₹)","type": "text", "required": True},
        *_ADVOCATE_FIELDS,
    ],
    "format_spec": (
...
REVISION_PETITION = {
    ...
    "fields": [
        {"key": "court_name",          "label_en": "Revisional Court",              "label_hi": "पुनरीक्षण न्यायालय",          "type": "text",     "required": True, "hint": "Sessions Court (HC's order: HC). Revision lies to the next-higher court."},
        {"key": "revisionist_name",    "label_en": "Revisionist name",              "label_hi": "पुनरीक्षणकर्ता का नाम",       "type": "name",     "required": True},
        {"key": "revisionist_father",  "label_en": "Father's name",                 "label_hi": "पिता का नाम",                 "type": "name",     "required": True},
        {"key": "revisionist_address", "label_en": "Address",                       "label_hi": "पता",                          "type": "address",  "required": True},
        {"key": "respondent_name",     "label_en": "Respondent",                    "label_hi": "विपक्षी",                     "type": "text",     "required": True, "hint": "Usually 'State' or the opposite party"},
        {"key": "impugned_court",      "label_en": "Court that passed impugned order","label_hi": "विवादित आदेश पारित न्यायालय","type": "text",    "required": True},
        {"key": "impugned_case_no",    "label_en": "Case no. in impugned court",    "label_hi": "विवादित न्यायालय का केस क्रमांक","type": "text", "required": True},
        {"key": "impugned_order_date", "label_en": "Date of impugned order",        "label_hi": "विवादित आदेश की दिनांक",      "type": "date",     "required": True},
        {"key": "summary_of_order",    "label_en": "Summary of the impugned order", "label_hi": "विवादित आदेश का सार",          "type": "longtext", "required": True},
        {"key": "grounds_for_revision","label_en": "Grounds for revision",          "label_hi": "पुनरीक्षण के आधार",            "type": "longtext", "required": True, "hint": "Illegality / impropriety / jurisdictional error"},
        *_ADVOCATE_FIELDS,
    ],
    "format_spec": (
...
REPLY_TO_BAIL = {
    ...
    "fields": [
        {"key": "court_name",            "label_en": "Court",                       "label_hi": "न्यायालय",                "type": "text",     "required": True},
        {"key": "bail_application_no",   "label_en": "Bail Application No.",        "label_hi": "जमानत आवेदन क्रमांक",     "type": "text",     "required": True},
        {"key": "bail_application_date", "label_en": "Date of bail application",    "label_hi": "जमानत आवेदन की दिनांक",   "type": "date",     "required": False},
        {"key": "accused_name",          "label_en": "Accused (bail applicant)",    "label_hi": "अभियुक्त (जमानत आवेदक)",  "type": "name",     "required": True},
        {"key": "fir_number",            "label_en": "FIR No.",                     "label_hi": "FIR क्रमांक",             "type": "text",     "required": True},
        {"key": "police_station",        "label_en": "Police Station",              "label_hi": "पुलिस थाना",              "type": "text",     "required": True},
        {"key": "sections_str",          "label_en": "Sections",                    "label_hi": "धाराएं",                  "type": "section_list", "required": True},
        {"key": "deponent_name",         "label_en": "Deponent's name",             "label_hi": "शपथकर्ता का नाम",         "type": "name",     "required": True, "hint": "Usually I.O. / S.P. / complainant"},
        {"key": "deponent_designation",  "label_en": "Deponent's designation",      "label_hi": "शपथकर्ता का पद",          "type": "text",     "required": True},
        {"key": "grounds_for_opposing",  "label_en": "Grounds for opposing bail",   "label_hi": "जमानत का विरोध करने के आधार","type": "longtext", "required": True, "hint": "Gravity, evidence, flight risk, witness tampering, prior record"},
        {"key": "investigation_status",  "label_en": "Status of investigation",     "label_hi": "जांच की स्थिति",          "type": "longtext", "required": False, "hint": "What's collected so far, what's pending"},
        {"key": "filing_party",          "label_en": "Filing on behalf of",         "label_hi": "किस ओर से दाखिल",         "type": "text",     "required": True, "hint": "Prosecution / Complainant / Both"},
        *_ADVOCATE_FIELDS,
    ],
    "format_spec": (
...
APPEAL_CONVICTION = {
    ...
    "fields": [
        {"key": "court_name",        "label_en": "Appellate court",                 "label_hi": "अपीलीय न्यायालय",         "type": "text",     "required": True, "hint": "Sessions (for Mag convictions); HC (for Sessions convictions); SC (for HC convictions)"},
        {"key": "appellant_name",    "label_en": "Appellant (convict) name",        "label_hi": "अपीलार्थी का नाम",        "type": "name",     "required": True},
        {"key": "appellant_father",  "label_en": "Father's name",                   "label_hi": "पिता का नाम",             "type": "name",     "required": True},
        {"key": "appellant_address", "label_en": "Address",                         "label_hi": "पता",                     "type": "address",  "required": True},
        {"key": "convicting_court",  "label_en": "Convicting court (trial court)",  "label_hi": "दोषसिद्ध करने वाला न्यायालय","type": "text",    "required": True},
        {"key": "trial_case_no",     "label_en": "Trial case number",               "label_hi": "विचारण केस क्रमांक",      "type": "text",     "required": True},
        {"key": "conviction_date",   "label_en": "Date of conviction judgment",     "label_hi": "दोषसिद्धि की दिनांक",     "type": "date",     "required": True},
        {"key": "sections_convicted","label_en": "Sections convicted under",        "label_hi": "जिन धाराओं में दोषसिद्धि","type": "section_list", "required": True},
        {"key": "sentence_passed",   "label_en": "Sentence",                        "label_hi": "सज़ा",                    "type": "text",     "required": True, "hint": "e.g. '7 years RI + ₹50,000 fine'"},
        {"key": "current_jail",      "label_en": "Current jail (if in custody)",    "label_hi": "वर्तमान कारागार",         "type": "text",     "required": False},
        {"key": "grounds_for_appeal","label_en": "Grounds of appeal",               "label_hi": "अपील के आधार",            "type": "longtext", "required": True, "hint": "Errors of law / fact / appreciation of evidence"},
        {"key": "facts_narrative",   "label_en": "Brief facts of prosecution case", "label_hi": "अभियोजन के संक्षिप्त तथ्य","type": "longtext", "required": True},
        *_ADVOCATE_FIELDS,
    ],
    "format_spec": (
