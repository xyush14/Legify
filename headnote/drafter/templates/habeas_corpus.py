...
def _doc(a, hi):
    ...
    cn = a.get("court_name") or (compose_court_name("hc", a.get("court_city"), a.get("state_name") or "", lang=("hi" if hi else "en")) if a.get("court_city") else (_HC if hi else "High Court of M.P., Bench at Gwalior"))
    hdr = render_header({
