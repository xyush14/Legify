...
def _doc(a, hi):
    ...
    # Always via the pan-India chokepoint — blank HC placeholder when state unknown, never MP.
    cn = a.get("court_name") or compose_court_name("hc", a.get("court_city"), a.get("state_name") or "", lang=("hi" if hi else "en"))
    hdr = render_header({
