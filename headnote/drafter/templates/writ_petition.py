...
def render_hi(a: dict) -> str:
    ...
    court_name = a.get("court_name") or compose_court_name("hc", a.get("court_city"), "म.प्र.") \
...
def render_en(a: dict) -> str:
    ...
    art = _esc(a.get("articles") or "226/227")
    court_name = a.get("court_name") or compose_court_name("hc", a.get("court_city"), "M.P.", lang="en")
    hdr = render_header({
