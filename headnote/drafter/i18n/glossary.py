...
TERMS: dict[str, dict[str, str]] = {
    ...
    # ---- cause-title / attestation (used by the Draft DNA .docx renderer too) ----
    "विरुद्ध":            {"mr": "विरुद्ध", "bn": "বিরুদ্ধে", "gu": "વિરુદ્ધ"},
    "बनाम":              {"mr": "विरुद्ध", "bn": "বনাম", "gu": "વિરુદ્ધ"},
    "सत्यापन":           {"mr": "सत्यापन", "bn": "সত্যপাঠ", "gu": "સત્યાપન"},
    "आवेदक":             {"mr": "अर्जदार", "bn": "আবেদনকারী", "gu": "અરજદાર"},
    "अनावेदक":           {"mr": "गैरअर्जदार", "bn": "প্রতিবাদী", "gu": "સામાવાળા"},
