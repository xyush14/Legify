...
def _generate_document(template: dict, collected: dict, lang: str) -> str:
    ...
    sys = (
        ...
        "as given.\n\n"
        "MANDATORY TOP-SECTION — this OVERRIDES any header / cause-title in the "
        "FORMAT SPEC below. EXCEPTION: for a वकालतनामा (vakalatnama), a standalone "
        "शपथ पत्र (affidavit), a विधिक नोटिस (legal notice), or a mention memo, SKIP "
        "this block and follow the FORMAT SPEC's own opening. Otherwise open EVERY "
        "document with exactly these lines, in order:\n"
